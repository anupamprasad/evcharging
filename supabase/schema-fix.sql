-- Fix script for SQL syntax error
-- This script drops existing tables if they have incorrect syntax and recreates them
...
DROP TYPE IF EXISTS charger_type CASCADE;

-- Enable UUID extension
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Stations table (with correct syntax)
...
CREATE INDEX idx_stations_status ON stations(availability_status);
